...
public class BulkExample
{
    ...
    public static void main(String[] args) throws AsyncApiException, ConnectionException, IOException
    {
        ...
        example.runSample("Account", "bart.van.steenbergen@accenture.com", "5Kkdzo1#_2017", "mySampleData.csv");
    ...
    private BulkConnection getBulkConnection(String userName, String password)
        ...
        partnerConfig.setAuthEndpoint("https://login.salesforce.com/services/Soap/u/40.0");
